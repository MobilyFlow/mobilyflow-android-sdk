...
internal class MobilyPurchaseSDKImpl(
    ...
    private var API: MobilyPurchaseAPI? = null
    private var waiter: MobilyPurchaseSDKWaiter? = null
    private var syncer: MobilyPurchaseSDKSyncer? = null
    ...
    init {
        ...
        synchronized(initLock) {
            ...
            this.reinit(appId, apiKey, environment, options)
        }
    ...
    internal fun reinit(
        ...
        synchronized(this.initLock) {
            ...
            // Re-create object that may changes
            this.API = MobilyPurchaseAPI(
                appId,
                apiKey,
                environment,
